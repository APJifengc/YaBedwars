...
public class Compass implements Listener {
    ...
    public void onInteract(PlayerInteractEvent e) {
        ...
        if (game.isSpectator(player))
            return;
        if (e.getItem() != null && e.getItem().isSimilar(this.compassItem) && (
        ...
        PacketAdapter packetAdapter = new PacketAdapter(YaBedwars.getInstance(), ListenerPriority.HIGHEST,
            ...
            public void onPacketReceiving(PacketEvent e) {
                ...
                if (player.getInventory().getItemInHand() != null &&
                        player.getInventory().getItemInHand().isSimilar(Compass.this.compassItem)) {
                    e.setCancelled(true);
    ...
    private void openSelectTeamMenu(Player player, String gui) {
        ...
        for (Team team : game.getTeams().values()) {
            if (!team.equals(game.getPlayerTeam(player))) {
                ...
                ItemStack itemStack1 = wool.toItemStack(1);
                ItemMeta itemMeta1 = itemStack1.getItemMeta();
                itemMeta1.setDisplayName(team.getChatColor() + team.getName());
