package com.yallage.yabedwars.metrics;
        ...
        for (Class<?> service : Bukkit.getServicesManager().getKnownServices()) {
            try {
                ...
                for (RegisteredServiceProvider<?> provider : Bukkit.getServicesManager().getRegistrations(service)) {
                    ...
                    } catch (NullPointerException | NoSuchMethodException | IllegalAccessException | java.lang.reflect.InvocationTargetException ignored) {
                    }
                }
        ...
        (new Thread(() -> {
            try {
                ...
                if (Metrics.logFailedRequests)
                    Metrics.this.plugin.getLogger().log(Level.WARNING, "Could not submit plugin stats of " + Metrics.this.plugin.getName(),
                            e);
            }
        })).start();
    }
