...
public class Config {
  ...
  public static void loadConfig() {
    ...
    timecommand_startcommand = 
      ColorUtil.listcolor(Main.getInstance().getConfig().getStringList("timecommand.startcommand"));
    ...
    destroyed_title_subtitle = 
      ColorUtil.color(Main.getInstance().getConfig().getString("destroyed_title.subtitle"));
    ...
    spectator_spectator_target_title = 
      ColorUtil.color(Main.getInstance().getConfig().getString("spectator.spectator_target.title"));
    spectator_spectator_target_subtitle = 
      ColorUtil.color(Main.getInstance().getConfig().getString("spectator.spectator_target.subtitle"));
    spectator_quit_spectator_title = 
      ColorUtil.color(Main.getInstance().getConfig().getString("spectator.quit_spectator.title"));
    spectator_quit_spectator_subtitle = 
      ColorUtil.color(Main.getInstance().getConfig().getString("spectator.quit_spectator.subtitle"));
    ...
    compass_lore_send_message = 
      ColorUtil.listcolor(Main.getInstance().getConfig().getStringList("compass.lore.send_message"));
    compass_lore_select_team = 
      ColorUtil.listcolor(Main.getInstance().getConfig().getStringList("compass.lore.select_team"));
    compass_lore_select_resources = 
      ColorUtil.listcolor(Main.getInstance().getConfig().getStringList("compass.lore.select_resources"));
    ...
    respawn_respawning_title = 
      ColorUtil.color(Main.getInstance().getConfig().getString("respawn.respawning.title"));
    respawn_respawning_subtitle = 
      ColorUtil.color(Main.getInstance().getConfig().getString("respawn.respawning.subtitle"));
    respawn_respawning_message = 
      ColorUtil.color(Main.getInstance().getConfig().getString("respawn.respawning.message"));
    ...
    respawn_respawned_subtitle = 
      ColorUtil.color(Main.getInstance().getConfig().getString("respawn.respawned.subtitle"));
    respawn_respawned_message = 
      ColorUtil.color(Main.getInstance().getConfig().getString("respawn.respawned.message"));
    ...
    witherbow_already_starte = 
      ColorUtil.color(Main.getInstance().getConfig().getString("witherbow.already_starte"));
    ...
    nobreakbed_nobreakmessage = 
      ColorUtil.color(Main.getInstance().getConfig().getString("nobreakbed.nobreakmessage"));
    ...
    holographic_resource.addAll(Main.getInstance().getConfig().getConfigurationSection("holographic.resource.resources").getKeys(false));
    holographic_bedtitle_bed_destroyed = 
      ColorUtil.color(Main.getInstance().getConfig().getString("holographic.bed_title.bed_destroyed"));
    holographic_bedtitle_bed_alive = 
      ColorUtil.color(Main.getInstance().getConfig().getString("holographic.bed_title.bed_alive"));
    ...
    for (String w : Main.getInstance().getConfig().getConfigurationSection("timer").getKeys(false))
      timer.put(w, Integer.valueOf(Main.getInstance().getConfig().getInt("timer." + w))); 
    ...
    scoreboard_team_bed_status_bed_alive = 
      ColorUtil.color(Main.getInstance().getConfig().getString("scoreboard.team_bed_status.bed_alive"));
    scoreboard_team_bed_status_bed_destroyed = 
      ColorUtil.color(Main.getInstance().getConfig().getString("scoreboard.team_bed_status.bed_destroyed"));
    scoreboard_team_status_format_bed_alive = 
      ColorUtil.color(Main.getInstance().getConfig().getString("scoreboard.team_status_format.bed_alive"));
    scoreboard_team_status_format_bed_destroyed = 
      ColorUtil.color(Main.getInstance().getConfig().getString("scoreboard.team_status_format.bed_destroyed"));
    scoreboard_team_status_format_team_dead = 
      ColorUtil.color(Main.getInstance().getConfig().getString("scoreboard.team_status_format.team_dead"));
    ...
    lobby_scoreboard_state_waiting = 
      ColorUtil.color(Main.getInstance().getConfig().getString("lobby_scoreboard.state.waiting"));
    lobby_scoreboard_state_countdown = 
      ColorUtil.color(Main.getInstance().getConfig().getString("lobby_scoreboard.state.countdown"));
    lobby_scoreboard_title = 
      ColorUtil.listcolor(Main.getInstance().getConfig().getStringList("lobby_scoreboard.title"));
